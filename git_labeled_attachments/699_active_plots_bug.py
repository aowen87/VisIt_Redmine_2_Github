...
<title>VisIt - active_plots_bug.py - VisIt Bugs</title>
...
<div class="nosidebar" id="main">
    ...
    <div id="content">
        ...
        <h2>active_plots_bug.py</h2>

<div class="attachments">
<p>Minimal example that reproduces the bug - 
   <span class="author">Jakob van Bethlehem, 07/15/2011 05:36 am</span></p>
<p><a href="/attachments/download/75/active_plots_bug.py">Download</a>   <span class="size">(212 Bytes)</span></p>
...
<tr><th class="line-num" id="L1"><a href="#L1">1</a></th><td class="line-code"><pre>#!/usr/bin/python -i
</pre></td></tr>


<tr><th class="line-num" id="L2"><a href="#L2">2</a></th><td class="line-code"><pre># -*- coding: utf-8 -*-
</pre></td></tr>
...
<tr><th class="line-num" id="L4"><a href="#L4">4</a></th><td class="line-code"><pre>from visit import *
</pre></td></tr>


<tr><th class="line-num" id="L5"><a href="#L5">5</a></th><td class="line-code"><pre>Launch()
</pre></td></tr>


<tr><th class="line-num" id="L6"><a href="#L6">6</a></th><td class="line-code"><pre>OpenGUI()
</pre></td></tr>
...
<tr><th class="line-num" id="L8"><a href="#L8">8</a></th><td class="line-code"><pre>def active_plots(ids, flag):
</pre></td></tr>


<tr><th class="line-num" id="L9"><a href="#L9">9</a></th><td class="line-code"><pre>  print &quot;SetActivePlotsRPC catched :&quot;,ids
</pre></td></tr>
...
<tr><th class="line-num" id="L12"><a href="#L12">12</a></th><td class="line-code"><pre>RegisterCallback('SetActivePlotsRPC', active_plots)
</pre></td></tr>
