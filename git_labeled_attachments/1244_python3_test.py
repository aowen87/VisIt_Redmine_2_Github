...
<title>VisIt - python3_test.py - VisIt Bugs</title>
...
<div class="nosidebar" id="main">
    ...
    <div id="content">
        ...
        <h2>python3_test.py</h2>

<div class="attachments">
<p>
   <span class="author">Cyrus Harrison, 02/08/2013 02:07 pm</span></p>
<p><a href="/attachments/download/167/python3_test.py">Download</a>   <span class="size">(105 Bytes)</span></p>
...
<tr><th class="line-num" id="L1"><a href="#L1">1</a></th><td class="line-code"><pre>#!/usr/bin/env python3
</pre></td></tr>


<tr><th class="line-num" id="L2"><a href="#L2">2</a></th><td class="line-code"><pre>import sys, string
</pre></td></tr>


<tr><th class="line-num" id="L3"><a href="#L3">3</a></th><td class="line-code"><pre>print(sys.version)
</pre></td></tr>


<tr><th class="line-num" id="L4"><a href="#L4">4</a></th><td class="line-code"><pre>b = string.find(&quot;sentence&quot;, &quot;s&quot;)
</pre></td></tr>


<tr><th class="line-num" id="L5"><a href="#L5">5</a></th><td class="line-code"><pre>print(b)
</pre></td></tr>
